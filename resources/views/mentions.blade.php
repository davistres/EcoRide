    ...
    <main class="home mention">
        <section class="mentions-legales">
            ...
            <p><b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du
                ...
                <b>Prestations et Services :</b> <a href="{{ url('/') }}">{{ url('/') }}</a> met à disposition
                des Clients :
            </p>
            ...
            <p><b>Informations clients :</b> Ci-après dénommé « Information (s) » qui correspondent à l’ensemble des
                données personnelles susceptibles d’être détenues par <a href="{{ url('/') }}">{{ url('/') }}</a>
                pour la gestion de votre compte, de la relation client et à des fins d’analyses et de statistiques.</p>
            ...
            <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie
                numérique, il est précisé aux utilisateurs du site internet <a href="{{ url('/') }}">{{ url('/') }}</a>
            ...
            <p>Le site internet <a href="{{ url('/') }}">{{ url('/') }}</a> a pour objet de fournir une information
                ...
                précises que possible.</p>

            <h2>4. Propriété intellectuelle et contrefaçons.</h2>
            <p><a href="{{ url('/') }}">{{ url('/') }}</a> est propriétaire des droits de propriété intellectuelle et
