                ...
                @foreach(session('covoiturages') as $covoiturage)
                    <div class="covoiturage-card">
                        <div class="covoiturage-driver">
                            <img src="{{ asset($covoiturage['photo_chauffeur']) }}" alt="Photo de {{ $covoiturage['pseudo_chauffeur'] }}" class="driver-photo">
                        ...
                        <div class="covoiturage-booking">
                            <div class="trip-seats">
                                <i class="icon-user"></i>
                                <span>{{ $covoiturage['places_restantes'] }} {{ $covoiturage['places_restantes'] > 1 ? 'places disponibles' : 'place disponible' }}</span>
                            </div>
        ...
        @else
            <div class="welcome-message">
                ...
                <section>
                    <div class="covoiturage-card">
                        <div class="covoiturage-driver">
                            <img src="{{ asset('images/default-avatar.jpg') }}" alt="Photo de Jean Dupont" class="driver-photo">
                            <div class="driver-info">
                                <h3>Jean Dupont</h3>
                                <div class="driver-rating">
