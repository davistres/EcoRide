...
<main class="home">
    ...
    <section class="presentation">
        <div class="text-content">
            ...
            <p>EcoRide est une startup française engagée dans la réduction de l'impact environnemental des
                déplacements. Notre mission est de rendre le covoiturage accessible à tous tout en préservant notre
                planète.</p>
